        ...
        return http
                ...
                .authorizeExchange(authorizeExchange -> {
                    ...
                    authorizeExchange
                        ...
                        .pathMatchers("/", "/health", "/api/users/health", "/api/concepts/health", "/api/genai/health", "/auth/login", "/auth/register", "/auth/refresh", "/auth/logout", "/api/auth/register").permitAll()
